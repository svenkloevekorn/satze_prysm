    ...
    public function run(): void
    {
        ...
        if ($castelli) {
            Rating::firstOrCreate(
                ...
                ['user_id' => $adminId, 'type' => 'internal', 'score' => 8, 'comment' => 'Schönes, klares Design', 'rated_at' => now()->subWeeks(1)],
            );
            Rating::firstOrCreate(
                ['ratable_type' => 'competitor_product', 'ratable_id' => $castelli->id, 'rating_dimension_id' => $material?->id],
                ['user_id' => $adminId, 'type' => 'internal', 'score' => 9, 'comment' => 'Sehr atmungsaktiv', 'rated_at' => now()->subWeeks(1)],
            );
            Rating::firstOrCreate(
                ['ratable_type' => 'competitor_product', 'ratable_id' => $castelli->id, 'rating_dimension_id' => null],
                ['user_id' => $adminId, 'type' => 'external', 'score' => 8, 'comment' => 'Durchschnitt aus 50 Online-Reviews', 'positives' => 'Komfort', 'negatives' => 'Preis', 'rated_at' => now()->subDays(10)],
            );
        }
        ...
        if ($rapha) {
            Rating::firstOrCreate(
                ...
                ['user_id' => $adminId, 'type' => 'internal', 'score' => 10, 'comment' => 'Top Performance auf langen Touren', 'rated_at' => now()->subDays(3)],
            );
        }
        ...
        if ($supplierProduct) {
            Rating::firstOrCreate(
                ...
                ['user_id' => $adminId, 'type' => 'internal', 'score' => 7, 'comment' => 'Solides Material, kein Premium', 'rated_at' => now()->subDays(5)],
            );
        }
    }
}
